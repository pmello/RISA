...
±±ºPrograma  ³ FA60FIL ºAutor  ³ Flavio Dias         º Data ³  28/10/20   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Adiocnar Filtro adicinais para geração do                  º±±
±±º          ³ borderô no financeiro                                      º±±
...
oDlg1      := MSDialog():New( 084,218,486,991,"Filtro Borderô - Contas a Receber",,,.F.,,,,,,.T.,,,.T. )
...
_cFiltro := " ((E1_GCCONTC>='"+nG1I+"' .AND. E1_GCCONTC<='"+nG1F+"')"
