...
ฑฑบPrograma  ณ F450Fil1 บAutor  ณ Flavio Dias         บ Data ณ  28/10/20  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Adiocnar Filtro adicinais para gera็ใo da                  บฑฑ
ฑฑบ          ณ conpensa็ใo entre o financeiro                             บฑฑ
...
oDlg1      := MSDialog():New( 084,218,486,991,"Filtro Contas a Pagar",,,.F.,,,,,,.T.,,,.T. )
...
_cFiltro := " and ((E2_FORNECE>='"+nGFI+"' and E2_FORNECE<='"+nGFF+"') and (E2_VALOR>="+REPLACE(nGVI,',','.')+" and E2_VALOR<="+REPLACE(REPLACE(nGVF,".",""),',','.')+") "
