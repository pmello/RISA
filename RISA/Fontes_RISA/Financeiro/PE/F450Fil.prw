...
±±ºPrograma  ³ F450FIL ºAutor  ³ Flavio Dias         º Data ³  28/10/20   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Adiocnar Filtro adicinais para geração da                  º±±
±±º          ³ conpensação entre o financeiro                             º±±
...
oDlg1      := MSDialog():New( 084,218,486,991,"Filtro Contas a Receber",,,.F.,,,,,,.T.,,,.T. )
